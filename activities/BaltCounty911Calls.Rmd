...
The pattern is generally constant, hovering around 10 calls per day. There is a noticeable incline in the early summer months of 2022. There was also a decline from October onward into January 2023. There waas an unusually low number in June 2022, and unusually high points in July, October, and late December into early January 2023.
...
This visualization shows that there are more unusually high days than unusually low days in the summer months, and more unusually low days transitioning into the winter months. In the previous answer, I had the same data, but this visualization better demonstrated where the data shows the largest outliers and where the story in the data is, rather than just the blatant outliers that are immediately apparent.
...
To avoid referencing "z-scores," you need to put that finding into the context of the story. One way to do that would be referencing what percentile an outlier falls into in the wider dataset, which is a much more simple point of reference for readers than z-scores are.
...
Based on this analysis, a reporter would look into what caused these extreme outliers: why were calls so high on 10/4? Why were two of the three days with the highest number of calls in July? What leads to such a low number of calls in December, Feburary, and other cold months?

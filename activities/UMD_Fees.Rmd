...
```{r}
umd_fees_pct2524 <- umd_fees |> mutate(pct_change = (`Fall 2025`- `Fall 2024`)/`Fall 2024` * 100)
```
...
The biggest increase in the span of 2024-2025 is a boost in student activities fees of over 14%. Where is that money going and how are these fees being implemented? The same can be said about the increase in bus fees of over 9%.
